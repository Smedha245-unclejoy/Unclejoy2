...
/**
 * Created by medha singh on 7/12/2016.
 */
...
public class CircleIndicator extends LinearLayout {
    ...
    private int mAnimatorResId = R.animator.indicator_animator;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        setGravity(gravity >= 0 ? gravity : Gravity.CENTER|Gravity.BOTTOM);
    ...
    public void configureIndicator(int indicatorWidth, int indicatorHeight, int indicatorMargin) {
        configureIndicator(indicatorWidth, indicatorHeight, indicatorMargin,R.animator.indicator_animator
                , 0, R.drawable.black_radius, R.drawable.black_radius);
    }
    ...
    private void checkIndicatorConfig(Context context) {
        ...
        mAnimatorResId = (mAnimatorResId == 0) ? R.anim.indicator_animator : mAnimatorResId;
